...
{
    public partial class Detailscleaneddatum
    {
        ...
        public string? Unnamed40 { get; set; }
        public string? Locale { get; set; }
        public string? Description { get; set; }
        public string? BurialnumberY { get; set; }
        public string? Sampledate { get; set; }
        public string? Photographeddate { get; set; }
        public string? IdY { get; set; }
        public string? DonebyX { get; set; }
        public decimal? AnalysistypeX { get; set; }
