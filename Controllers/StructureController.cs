...
namespace fag_el_gamous.Views
{
    public class StructureController : Controller
    {
        ...
        public StructureController(postgresContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Structures != null ? 
                          ...
                          Problem("Entity set 'postgresContext.Structures'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Value,Structureid")] Structure structure)
        {
            if (id != structure.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'postgresContext.Structures'  is null.");
            }
            var structure = await _context.Structures.FindAsync(id);
            if (structure != null)
            {
